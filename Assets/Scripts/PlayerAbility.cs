...
public class PlayerAbility : MonoBehaviour
{
    ...
    public float invulnerabilityDuration = 1.0f;   // how long you're invulnerable after pressing Space
    public float cooldownDuration = 5.0f;          // how long until you can use it again
    public GameObject cloudEffect;                 // assign a child object with your cloud sprite here
